...
This is a basic text based gui that naviagates the program
...
public class BasicGui {
	...
	// @param num- specifies how many agents you want
	// Creates the main container with the schduling agents.
